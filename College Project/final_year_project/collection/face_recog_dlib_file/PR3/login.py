...
class Login:
    def __init__(self,root):
        ...
        bg1=Image.open(r"UI_Images/banner_login.png")
        ...
        img1=Image.open(r"UI_Images/log1.png")
        ...
        #label1 
        user =lb1= Label(frame1,text="Email Address:",font=("times new roman",15,"bold"),fg="white",bg="#002B53")
        ...
        loginbtn=Button(frame1,command=self.reg,text="Register",font=("times new roman",10,"bold"),bd=0,relief=RIDGE,fg="#002B53",bg="white",activeforeground="white",activebackground="#007ACC")
        loginbtn.place(x=33,y=370,width=50,height=20)


        # Creating Button Forget
        loginbtn=Button(frame1,command=self.forget_pwd,text="Forget",font=("times new roman",10,"bold"),bd=0,relief=RIDGE,fg="#002B53",bg="white",activeforeground="white",activebackground="#007ACC")
