...
class Student:
    ...
    # This part is image labels setting start 
        ...
        dep_combo["values"]=("Select Department","Computer Engineering","Civil Engineering","Software Engineering","IT Engineering","Elx. & Comm. Engineering", "Management")
        dep_combo.current(0)
        ...
        cou_combo["values"]=("Select Course","BE Software","BE Computer","BE IT","BE Civil","BBA","BCA")
        cou_combo.current(0)
        ...
        #Class Didvision
        student_div_label = Label(class_Student_frame,text="Class Shift:",font=("verdana",12,"bold"),fg="navyblue",bg="white")
        ...
        if self.var_dep.get()=="Select Department" or self.var_course.get=="Select Course" or self.var_year.get()=="Select Year" or self.var_semester.get()=="Select Semester" or self.var_std_id.get()=="" or self.var_std_name.get()=="" or self.var_div.get()=="" or self.var_roll.get()=="" or self.var_gender.get()=="":
            ...
            try:
                ...
                if Update > 0:
                    conn = mysql.connector.connect(user='root', password='root',host='localhost',database='proj_db',port=8889)
                    mycursor = conn.cursor()
                    mycursor.execute("update student set Name=%s,Department=%s,Course=%s,Year=%s,Semester=%s,Division=%s,Gender=%s,Roll_No=%s,PhotoSample=%s where Student_ID=%s",( 
                    self.var_std_name.get(),
                    self.var_dep.get(),
                    self.var_course.get(),
                    self.var_year.get(),
    ...
    def search_data(self):
        if self.var_search.get()=="" or self.var_searchTX.get()=="Select":
            ...
            try:
                ...
                sql = "SELECT Student_ID,Name,Department,Course,Year,Semester,Division,Gender,Roll_No,PhotoSample FROM student where Roll_No='" +str(self.var_search.get()) + "'" 
