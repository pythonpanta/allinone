...
class Register:
    def __init__(self,root):
        ...
        frame.place(x=270,y=80,width=900,height=580)
        
        get_str2 = Label(frame,text="Student Attendance Log Keeping using face_recognition() System",font=("times new roman",30,"bold"),fg="white",bg="#002B53")
        get_str2.place(x=30,y=50)
