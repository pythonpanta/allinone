...
class Register:
    def __init__(self,root):
        ...
        frame.place(x=270,y=80,width=1000,height=580)
        
        get_str2 = Label(frame,text="Student Attendance System",font=("times new roman",30,"bold"),fg="white",bg="#002B53")
        get_str2.place(x=250,y=50)
