...
class Attendance:
    ...
    def __init__(self,root):
        ...
        #title section
        title_lb1 = Label(bg_img,text="Attendance Report ",font=("verdana",30,"bold"),bg="white",fg="navyblue")
        ...
        # Left Label Frame 
        left_frame = LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student's Attendance Information",font=("verdana",12,"bold"),fg="navyblue")
        ...
        # Right Label Frame 
        right_frame = LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student's Attendance on Database",font=("verdana",12,"bold"),fg="navyblue")
        right_frame.place(x=680,y=10,width=700,height=480)
        ...
        table_frame.place(x=10,y=90,width=700,height=360)
        ...
        #create table 
        self.attendanceReport = ttk.Treeview(table_frame,column=('said',"ID","Roll_No","Name","Time","Date","Attend"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
        ...
        self.attendanceReport.heading("said",text="PK")
        ...
        # Set Width of Colums 
        self.attendanceReport.column("said",width=100)
