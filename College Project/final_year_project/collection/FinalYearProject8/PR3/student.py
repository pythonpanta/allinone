...
class Student:
    def __init__(self,root):
        self.root=root
        self.root.title("Register Nwe Student..")
        ...
        #title section
        title_lb1 = Label(bg_img,text="   Student's Information Form   ",font=("verdana",30,"bold"),bg="white",fg="navyblue")
        title_lb1.place(x=10,y=0,width=1540,height=45)
        ...
        # Left Label Frame 
        left_frame = LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student's Academic Information",font=("verdana",12,"bold"),fg="navyblue")
        left_frame.place(x=10,y=10,width=660,height=480)

        # Current Course 
        current_course_frame = LabelFrame(left_frame,bd=2,bg="white",relief=RIDGE,text="Enrolled Course Information",font=("verdana",12,"bold"),fg="navyblue")
        ...
        dep_combo["values"]=("Select Department","Computer Engineering","Civil Engineering","IT")
        dep_combo.current(0)
        ...
        cou_combo["values"]=("Select Course","BE Computer","BE IT","BE Civil")
        cou_combo.current(0)
        ...
        year_combo["values"]=("Select Year","2022","2021","2019","2018","2017","2016",)
        ...
        year_combo["values"]=("Select Semester","Sem-I","Sem-II","Sem-III","Sem-IV","Sem-V","Sem-VI","Sem-VII","Sem-VIII")
        year_combo.current(0)
        ...
        #Student id
        studentId_label = Label(class_Student_frame,text="Student's ID:",font=("verdana",12,"bold"),fg="navyblue",bg="white")
        ...
        #Student name
        student_name_label = Label(class_Student_frame,text="Student's Name:",font=("verdana",12,"bold"),fg="navyblue",bg="white")
        ...
        radiobtn1.grid(row=4,column=1,padx=5,pady=5,sticky=W)
        ...
        #----------------------------------------------------------------------
        # Right Label Frame 
        right_frame = LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student's Academic Information Display",font=("verdana",12,"bold"),fg="navyblue")
        right_frame.place(x=680,y=10,width=820,height=480)
        ...
        search_frame.place(x=10,y=5,width=800,height=80)
        ...
        table_frame.place(x=10,y=90,width=800,height=360)
        ...
        #create table 
        self.student_table = ttk.Treeview(table_frame,column=("ID","Name","Dep","Course","Year","Sem","Div","Gender","Roll-No","Photo"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
...
# ==================Function Decleration==============================
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_course.get=="Select Course" or self.var_year.get()=="Select Year" or self.var_semester.get()=="Select Semester" or self.var_std_id.get()=="" or self.var_std_name.get()=="" or self.var_div.get()=="" or self.var_roll.get()=="" or self.var_gender.get()=="":
            messagebox.showerror("Error","Please Fill All Fields are Required!",parent=self.root)
        else:
            try:
                conn = mysql.connector.connect(user='root', password='',host='localhost',database='proj_db')
                ...
                if row!=None:
                    messagebox.showerror("Error","User already exist,please try another Student_ID" ,parent=self.root)
                else:
                    mycursor.execute("insert into students values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",(
                    self.var_std_id.get(),
    ...
    def get_cursor(self,event=""):
        try:
            ...
            messagebox.showinfo("Error",f"{e}",parent=self.root)
        ...
        if self.var_dep.get()=="Select Department" or self.var_course.get=="Select Course" or self.var_year.get()=="Select Year" or self.var_semester.get()=="Select Semester" or self.var_std_id.get()=="" or self.var_std_name.get()=="" or self.var_div.get()=="" or self.var_roll.get()=="" or self.var_gender.get()=="":
            ...
            try:
                ...
                if Update > 0:
                    conn = mysql.connector.connect(user='root', password='',host='localhost',database='proj_db')
                    mycursor = conn.cursor()
                    mycursor.execute("update students set Name=%s,Department=%s,Course=%s,Year=%s,Semester=%s,Division=%s,Gender=%s,Roll_No=%s,PhotoSample=%s where Student_ID=%s",( 
                    self.var_std_name.get(),
                    self.var_dep.get(),
                    self.var_course.get(),
                    self.var_year.get(),
    ...
    def search_data(self):
        if self.var_search.get()=="" or self.var_searchTX.get()=="Select":
            ...
            try:
                ...
                sql = "SELECT Student_ID,Name,Department,Course,Year,Semester,Division,Gender,Roll_No,PhotoSample FROM students where Roll_No='" +str(self.var_search.get()) + "'" 
            ...
            try:  
                ...
                while True:
                    ...
                    if face_croped(my_frame) is not None:
                        ...
                        file_path="dataset/student."+str(id)+"."+str(img_id)+".jpg"
