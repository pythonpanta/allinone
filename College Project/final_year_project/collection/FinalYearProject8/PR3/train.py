...
class Train:
    ...
    def __init__(self,root):
        ...
        self.root.title("Training Dataset Page")
        ...
        #title section
        title_lb1 = Label(bg_img,text="Dataset Training",font=("verdana",30,"bold"),bg="white",fg="navyblue")
        title_lb1.place(x=0,y=0,width=1540,height=45)

        # Create buttons below the section 
        # ------------------------------------------------------------------------------------------------------------------- 
        # Training button 1
        std_img_btn=Image.open(r"UI_Images/train2.png")
    ...
    def train_classifier(self):
        ...
        for image in path:
            ...
            id=int(os.path.split(image)[1].split('.')[1]) #id separated
